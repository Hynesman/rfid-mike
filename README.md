...
> Åbn denne side på [https://hynesman.github.io/rfid-mike/](https://hynesman.github.io/rfid-mike/)
...
* søg efter **https://github.com/hynesman/rfid-mike**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/hynesman/rfid-mike/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/hynesman/rfid-mike**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/hynesman/rfid-mike/raw/master/.github/makecode/blocks.png)
